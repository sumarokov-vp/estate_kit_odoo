# Estate Kit — Спецификация модуля
...
| Документ | Описание |
|----------|----------|
| [Модель данных](data-model.md) | Архитектура хранения данных (EAV) |
| [Атрибуты](attributes.md) | Полный список атрибутов (56 шт.) |
| [Интеграции](integrations.md) | Интеграции (CRM, ERP, 2GIS, S3) |
...
**Важно:** ERP работает с CRM (сделками), а не с объектами. Estate Kit — источник данных об объектах, CRM — источник данных для расчёта зарплат.
...
Подробнее: [Модель данных](data-model.md)
...
Подробнее: [Интеграции](integrations.md#2-отслеживание-участников-для-расчёта-комиссии)
